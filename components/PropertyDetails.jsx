import {FaBed, FaBath, FaCheck, FaMapMarker, FaRulerCombined, FaTimes} from 'react-icons/fa'
        ...
        <main>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
              ...
              >
                ...
                <li key={index}>  
                  <FaCheck className=" inline-block fas fa-check text-green-600 mr-2 "/> {amenity}
                </li>
                ))}
